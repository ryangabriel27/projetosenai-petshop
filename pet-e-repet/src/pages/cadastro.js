            ...
            <div className='cadastro-form'>
                ...
                <Formik
                    ...
                    <Form className="form--cadastro">
                        ...
                        <div className="inputs">
                            <Field type="password" placeholder='Digite seu CEP' name='cadastroCEP' style={{ backgroundImage: `url(${cepIcon})`, backgroundRepeat: "no-repeat", backgroundPosition: "20px 18px", padding: "12px 45px 12px 60px" }} />
                            <ErrorMessage
                                component="span"
                                name='cadastroCEP'
                                className='formError' />
